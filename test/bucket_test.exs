defmodule Bucket.BucketTest do
  ...
  test "#next/1" do
    ...
    assert Bucket.next("1|00000", 125) == "1|00021"
  ...
  test "#prev/1" do
    ...
    assert Bucket.prev("1|00021", 125) == "1|00000"
  ...
  test "#between" do
    ...
    assert Bucket.between("2|aaaaz", "2|zzzzz") == "2|nIIIU"
  ...
  test "#distance/2" do
    ...
    assert Bucket.distance("2|000", "2|zzz") == 238_327
